...
return [
    'auth' => [
        ...
        'invalid_login' => 'Unešeni detalji ne podudaraju sa onima u bazi, pokušajte ponovo.',
    ],
    'field' => [
    ...
    'page' => [
        ...
        'access_denied' => [
            ...
            'help' => "Nemate odgovarajuće dozvole za pristup ovoj stranici.",
    ...
    'dashboard' => [
        ...
        'welcome' => [
            'widget_title_default' => 'Dobrodošao',
            'welcome_back_name' => 'Dobrodošao nazad na :app, :name.',
            'welcome_to_name' => 'Dobrodošao na :app, :name.',
            'first_sign_in' => 'Prvi put si se ulogovao.',
            'last_sign_in' => 'Tvoje poslednje logovanje je bilo na',
    ...
    'user' => [
        ...
        'deny' => 'Odbij',
        'activated' => 'Aktiviran',
        'last_login' => 'Poslednjeg logovanje:',
    ...
    'form' => [
        ...
        'create_success' => ':name napravljena',
        'update_success' => ':name ažurirana',
        'delete_success' => ':name obrisana',
        'restore_success' => ':name povraćena',
        'reset_success' => 'Resetovanje završeno',
        'missing_id' => 'ID zapisa obrasca nije specificiran.',
        ...
        'action_confirm' => 'Da li si siguran?',
        'create' => 'Napravi',
        ...
        'concurrency_file_changed_description' => "Fajl nad kojim si radio je u međuvremenu promenjen od strane drugog korisnika. Možeš ponovo da ga učitaš i izgubiš svoje promene, ili ga jednostavno pregaziš.",
    ...
    'relation' => [
        ...
        'delete_confirm' => 'Da li si siguran?',
        'link' => 'Zakači',
        'link_name' => 'Zakači :name',
        'unlink' => 'Otkači',
        'unlink_name' => 'Otkači :name',
        'unlink_confirm' => 'Da li si siguran?',
    ],
    'reorder' => [
    ...
    'model' => [
        ...
        'invalid_class' => "Model :model korišćen :class nije validan, mora da nasledi klasu \Model.",
    ...
    'warnings' => [
        ...
        'extension' => 'Produžetak za PHP :name nije instalirana. Instalirajte ovu biblioteku i instalirajte produžetak.',
    ...
    'branding' => [
        ...
        'app_name_description' => 'Ovo ime će prikazati kao naslov pozadinskog sistema.',
