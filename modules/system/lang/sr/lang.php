...
return [
    ...
    'project' => [
        ...
        'id' => [
            'label' => 'ID projekta',
            'help' => 'Kako pronaći tvoj ID projekta',
    ...
    'mail_templates' => [
        ...
        'no_layout' => '-- Bez plana --',
        'name' => 'Naziv',
        'name_comment' => 'Unikatni naziv za referenciranje ovog šablon.',
        'code' => 'Kod',
    ...
    'mail_brand' => [
        ...
        'sample_template' => [
            ...
            'subcopy' => 'Ovo je kopija kopije ovog mejla.',
            'thanks' => 'Hvala',
        ],
        'fields' => [
            ...
            'header_color' => 'Boja zaglavlja pošte',
            ...
            'subcopy_border_color' => 'Boja ivica kopije kopije',
    ...
    'server' => [
        ...
        'response_not_found' => 'Server za ispravke nije mogao biti pronađen.',
        'response_invalid' => 'Odgovor od servera nije validan.',
        'response_empty' => 'Prazan odgovor od servera.',
    ...
    'config' => [
        'not_found' => 'Konfiguracioni fajl :file za definisanu :location nije mogao biti pronađen.',
        'required' => "Konfiguracija korišćena u :location mora obezbediti vrednost za ':property'.",
    ],
    'zip' => [
    ...
    'event_log' => [
        ...
        'empty_success' => 'Log dođaja je ispražnjen',
    ...
    'log' => [
        ...
        'log_events_comment' => 'Čuvanje sistemskih događaja u bazi podataka u bazi podataka, pored čuvanja na fajlu.',
        'log_requests' => 'Log loših zahteva',
        'log_requests_comment' => 'Zahtevi koji zahtevaju vašu pažnju.',
